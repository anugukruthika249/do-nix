          ...
          <div className="bg-red-600 rounded-[3rem] p-10 md:p-16 text-white relative overflow-hidden w-full max-w-5xl shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <div className="text-center mb-12">
                <h2 className="text-xs font-black tracking-[0.4em] text-red-200 uppercase mb-4">
                  The Innovation
                </h2>
                <h3 className="text-4xl md:text-5xl font-bold mb-6">
                  How Donix Changes the Game
                </h3>
              ...
              <div className="grid md:grid-cols-3 gap-12 mt-16">
                {[
                  ...
                  },
                  {
                    ...
                    text: 'Our system instantly notifies the closest compatible donors, cutting wait times by up to 80%.'
                  },
                  {
                    step: '3',
                  ...
                  >
                    {/* Step Number */}
                    <span className="text-4xl font-black text-white/40 mb-4 group-hover:text-white transition-colors duration-300">
                      {item.step}
                    </span>
                    ...
                    {/* Description */}
                    <p className="text-red-100/70 leading-relaxed text-sm">
                      {item.text}
                    </p>
                  </div>
                ))}
